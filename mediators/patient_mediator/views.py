...
from helpers.helpers import requests, getPortPart, pinChannel, getPaginatedRecords
...
def savePreference(request):
    try:
        ...
        if 'insurance product' in resources:
